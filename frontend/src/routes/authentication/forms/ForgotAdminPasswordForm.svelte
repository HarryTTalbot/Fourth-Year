<script>
  ...
  import {
    defaultAdminForgetPassword,
    ADMIN_FORGET_PASSWORD_SCHEMA,
  } from "./schemas";
  ...
  const {
    ...
    initialValues: defaultAdminForgetPassword(),
    validationSchema: ADMIN_FORGET_PASSWORD_SCHEMA,
